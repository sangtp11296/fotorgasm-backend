...
export const AlbumPage: React.FC<Props> = ({ album, cover}) => {
  return (
    <div className={styles.album}>
      <div className={styles.albumBackground} style={{background:`linear-gradient(180deg, ${album.dominantColor} 5vh, rgba(35,35,35,1) 46vh)`}}>
