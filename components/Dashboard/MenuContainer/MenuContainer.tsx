  ...
  return (
    <div className={`${styles.menuContainer} ${styles.gridBlock}`}>
        <Link href='/' className={styles.brandName}>
            {
                windowSize > 1200 ?
                <Image alt='logo-brand' fill className={styles.logoBrand} src='/assets/icons/fotorgasm-brand-name-white.png'></Image> :
                <Image alt='logo-brand' fill className={styles.logoBrand} src='/assets/icons/fotorgasm-logo-no-ring.png'></Image>
            }
        </Link>
        <div className={styles.mainMenu}>
            <ul>
                {
                    menuIcons.map((icon: MenuIconsObj) => {
                        return(
                            <li onClick={() => setClick(icon.name)}>
