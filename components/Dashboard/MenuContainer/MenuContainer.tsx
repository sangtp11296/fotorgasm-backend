...
const MenuContainer = () => {
    ...
    const menuIcons: MenuIconsObj[] = [
        ...
        },
        {
            ...
            title: 'Photos',
            icon: (
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={`${click==='photo'?'var(--on-background)':'var(--on-background-matte)'}`}>
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
        ...
        },
        {
            ...
            icon: (
                <svg  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g  id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier"> 
                        <path d="M3 11V13M6 8V16M9 10V14M12 7V17M15 4V20M18 9V15M21 11V13" stroke={`${click==='music'?'var(--on-background)':'var(--on-background-matte)'}`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> 
                    </g>
                </svg>
            )
        },
  ...
  return (
    <div className={`${styles.menuContainer} ${styles.gridBlock}`}>
        <Link href='/' className={styles.brandName}>
            {
                windowWidth! > 1355 ?
                <Image priority={true} alt='logo-brand' fill sizes='100vw' className={styles.logoBrand} src='/assets/icons/fotorgasm-brand-name-white.png'></Image> :
                <Image priority={true} alt='logo-brand' fill sizes='100vw' className={styles.logoBrand} src='/assets/icons/fotorgasm-logo-no-ring.png'></Image>
            }
        </Link>
