...
const PostSum: React.FC<Props> = ({ menuType }) => {
  ...
  const icons: { [key: string]: React.JSX.Element } = {
    'home': (
        <svg style={{fill:'var(--on-background)'}} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    'music': (
      <svg  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g  id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier"> 
              <path d="M3 11V13M6 8V16M9 10V14M12 7V17M15 4V20M18 9V15M21 11V13" stroke={'var(--on-background)'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> 
          </g>
      </svg>
    )
  }
