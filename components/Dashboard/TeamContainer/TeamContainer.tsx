                    ...
                    user.team.map((member, ind) => {
                        return(
                            <div key={ind} className={styles.memberContainer}>
                                <img height='50px' src={member.avatar}></img>
                                <div className={styles.memberName}>
                                    <h2>{member.name}</h2>
                                    {/* Use ' • ' as the separator */}
                                    <h3>{member.role.join(' • ')}</h3> 
                                </div>
                                ...
                                <div className={styles.functionWrapper}>
                                    ...
                                    {
                                        funcDot[member.name] ? 
                                        <button style={{backgroundColor: 'var(--surface-04)'}} onClick={() => setFuncdot((prevDots) => ({ ...prevDots, [member.name]: !prevDots[member.name] }))}>
