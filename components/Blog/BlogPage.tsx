...
export const BlogPage: React.FC<Props> = ({ post, cover }) => {
  ...
  console.log('landscape', containerRef)
  console.log('portrait', portraitPost)
  return (
    <>
      {
                      ...
                      <div className={styles.postInfoContainer}>
                        <div className={styles.postInfo}>
                          ...
                          <div className={styles.postSocial}>
                            ...
                            <button className={styles.likeBtn}>
                              <svg viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="var(--on-background)">
      ...
      }
      {
        ...
        <>
          <ScrollToHeadAndTail content={containerRef}/>
