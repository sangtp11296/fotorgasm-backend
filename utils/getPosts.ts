...
export const getPosts = async (page: number | string, perPage: number | string) => {
    ...
    // Get posts
    const res = await fetch(`https://vjbjtwm3k8.execute-api.ap-southeast-1.amazonaws.com/dev/posts?page=${page}&perPage=${perPage}`, {
        method: "GET",
    })
    // Mix 2 arrays
